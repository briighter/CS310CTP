...
public class StudentList {
	...
	public List<String> getStudentsNames() {
		...
		//Add my name (Kevin DeRespino) to the list of students
		String KevinDeRespino = "KevinDeRespino";
		studentNames.add(KevinDeRespino);
	...
	public Student GetStudentProfile(String student){
		...
		switch(student) {
		   ...
		   case "KevinDeRespino_Playlist":
			   ...
			   Student KevinDeRespino = new Student("KevinDeRespino", KevinDeRespinoPlaylist.StudentPlaylist());
			   return KevinDeRespino;
